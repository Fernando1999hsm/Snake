export default class Snake {
    constructor(scene) {
        ...
        //this.body.push(this.scene.add.rectangle(0, 0, 16, 16, 0xf0000ff).setOrigin(0));

        //this.body.push(this.scene.add.rectangle(0, 0, 16, 16, 0xfffffff).setOrigin(0));
    ...
    move(){
        ...
        if(this.apple.x === x && this.apple.y === y){
            //manzana comida
            this.body.push(this.scene.add.rectangle(0, 0, this.tileSize, this.tileSize, 0xfffffff).setOrigin(0));
            this.positionApple();
        }
        ...
        this.body[0].x = x;
        this.body[0].y = y;
        //Comprobacion de muerte por borde
        ...
        //Comprobacion de muerte por cola
